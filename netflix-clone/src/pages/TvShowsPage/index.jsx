...
const TvShowsPage = ({ title, category }) => {
    ...
    <div className='tvShowsPage'>
      <div className="inner">
        ...
        <div className="paragraph">
          <p>TV Shows move us like nothing else can, whether they’re scary, funny, dramatic, romantic or anywhere in-between. So many titles, so much to experience.</p>
        </div>
        </div>
